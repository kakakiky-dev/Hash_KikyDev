...
public class Main
{
	...
	{ 
    	...
    	try {
            BufferedReader br = new BufferedReader(new FileReader("../file/CrawlFile.txt"));
            while (strLine != null)
            {
        ...
        if(args[0].equals("show")){
            ...
            System.out.println("<table class='table table-dark mt-2 text-center'>");
        ...
        // and print into HTML format
             ...
             if(result != null) //if data found print it 
            {
                ...
                System.out.println("<h5 class='mb-3 text-white'>Daftar artikel dengan editor "+args[0]+" </h5>");
                System.out.print("<ul class='list-group'>");
                result.forEach((e)->System.out.print("<li class='table-dark mt-2'>"+e+"</li>"));
                System.out.print("</ul></br></br>");
            }
            else // status: 404
            {
                System.out.println("<h5 class='mb-3 text-white'>Data Untuk Editor "+args[0]+" Tidak Ditemukan");
            }
        }
	}  
}   